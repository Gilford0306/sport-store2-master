...
const handleCheckboxChange = useCallback((category, values) => {
  setFilters((prevFilters) => {
    ...
    const newCategoryValues = values.reduce((acc, value) => {
        ...
        <div className="filter-group">
          <label>
            <input
              type="checkbox"
              name="Одяг"
              onChange={(e) => handleCheckboxChange("categories", ["Всі","Одяг"])}
            />
            Одяг
          </label>
        </div>
...
<div className="filter-group">
  <label>
    <input
      ...
      name="Топи"
      onChange={(e) =>
        handleCheckboxChange("subcategories", ["Топ"])
      }
    />
    Топ
  </label>
...
<div className="filter-group">
  <label>
    <input
      ...
      name="Майки"
      onChange={(e) =>
        handleCheckboxChange("subcategories", ["Майка"])
      }
    />
    Майки
  </label>
...
<div className="filter-group">
  <label>
    <input
      ...
      name="Кофти"
      onChange={(e) =>
        handleCheckboxChange("subcategories", ["Кофта"])
      }
    />
    Кофта
  </label>
...
<div className="filter-group">
  <label>
    <input
      ...
      name="Поло"
      onChange={(e) =>
        handleCheckboxChange("subcategories", ["Поло"])
      }
    />
    Поло
  </label>
...
<div className="filter-group">
  <label>
    <input
      ...
      name="Сумки"
      onChange={(e) =>
        handleCheckboxChange("subcategories", ["Сумки"])
      }
    />
    Сумки
  </label>
